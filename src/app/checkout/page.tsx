...
export default function CheckoutPage() {
  ...
  if (totalItems === 0) {
    return (
        <div className="container mx-auto px-4 py-12 text-center">
            ...
            <p className="text-muted-foreground mb-8">You need to add items to your cart before you can check out.</p>
            <Button asChild>
  ...
  return (
    <div className="container mx-auto px-4 py-12">
      <h1 className="text-4xl md:text-5xl font-headline font-bold mb-8 text-center">
        Checkout
      </h1>
      <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)} className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div>
            ...
            <Button type="submit" size="lg" className="w-full mt-8 text-lg font-bold">
